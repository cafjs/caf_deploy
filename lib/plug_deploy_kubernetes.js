...
const processAppSpec = function(appSpec) {
...
const processRedisSpec = function(redisSpec) {
...
exports.newInstance = async function($, spec) {
    try {
        ...
        const __ca_updateApp__ = async function(appProps) {
            try {
                await __ca_statAll__();
        ...
        const __ca_restartApp__ = async function(appProps) {
            try {
                await __ca_statAll__();
        ...
        const __ca_deleteApp__ = async function(appProps) {
            try {
                await __ca_statAll__();
                const app = appsStatus[appProps.id];
                if (app) {
        ...
        const __ca_statAll__ = async function() {
            // does not catch exceptions...
            const res = await deployUtil.statAll();
            const apps = res[1];
