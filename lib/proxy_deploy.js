...
exports.newInstance = async function($, spec) {
    try {
         ...
         *
         * The type of the method should be `function(requestId, error, data,
         * cb)`
         *
         * where:
         *
         ...
         *
         *  This is useful for management applications that need to have a
         * global view of what has been deployed.
         *
         *  Kubernetes uses the default Redis port 6379 for all instances.
         *  Calling this method with a Kubernetes backend throws an error.
         *
         * This is a privileged operation that needs to be explicitly enabled
         * with `spec.env.listAllRedisPorts=true` in `framework.json`.
         *
